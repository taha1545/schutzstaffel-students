...
import { LayoutDashboard, Target, Calendar, Trophy, User, LogOut } from "lucide-react";
...
export function Sidebar() {
    ...
    //
    const userName = user?.fullName || "Agent Cadet";
    ...
    return (
        <aside className="hidden lg:flex flex-col w-64 h-screen bg-[#0F1923] border-r border-white/10 fixed left-0 top-0 z-50">
            ...
            {/* Profile Card */}
            <div className="p-4 mx-4 mt-6 mb-4 bg-white/3 border-l-2 border-primary relative group transition-colors hover:bg-white/[0.07]">
            ...
            {/* Unique Code Badge */}
            {user && (<div className="mx-4 mt-4 mb-2 px-3 py-1 bg-primary/20 text-white font-mono font-bold text-[10px] uppercase tracking-widest rounded-md border border-primary/50 flex items-center justify-center">
                {user.uniqueCode}
            </div>
            )}
            ...
            <div className="p-4 border-t border-white/5">
                <button
                    ...
                    className="w-full flex items-center gap-4 px-4 py-3 text-gray-500 hover:text-primary cursor-pointer transition-all group"
                >
